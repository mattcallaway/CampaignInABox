...
with st.sidebar:
    ...
    page = st.radio(
        "Navigation",
        ["🏛️ Jurisdiction", "📤 Upload Center", "▶️ Run Pipeline",
         "📊 Outputs Browser", "📋 Logs & NEEDS"],
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    <div class='ciab-header'>
        <h1>📤 Upload Center</h1>
        <p>Upload geography packs, election results, and voter files</p>
    </div>""", unsafe_allow_html=True)
...
# ═════════════════════════════════════════════════════════════════════════════
    ...
    <div class='ciab-header'>
        ...
        <p>Execute the election modeling pipeline with streaming log output</p>
    </div>""", unsafe_allow_html=True)
